...
import { ShieldCheck, HardHat, Award, ArrowRight, Activity, FileCheck } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 border-b border-slate-200 dark:border-slate-800 pb-8">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-slate-950 dark:text-white tracking-tight uppercase">
              Zero-Harm Standards
            </h2>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          <div className="p-6 rounded-2xl bg-white dark:bg-[#050C17] border border-slate-200 dark:border-slate-800 flex items-center space-x-4 shadow-sm">
            ...
            <div>
              <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400">Zero</div>
              <div className="text-xs font-bold text-slate-900 dark:text-white mt-0.5">Lost Time Incidents</div>
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-[#050C17] border border-slate-200 dark:border-slate-800 flex items-center space-x-4 shadow-sm">
            ...
            <div>
              <div className="text-2xl font-black text-amber-700 dark:text-[#D4AF37]">100%</div>
              <div className="text-xs font-bold text-slate-900 dark:text-white mt-0.5">PPE Compliance</div>
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-[#050C17] border border-slate-200 dark:border-slate-800 flex items-center space-x-4 shadow-sm">
            ...
            <div>
              <div className="text-2xl font-black text-blue-600 dark:text-blue-400">Daily</div>
              <div className="text-xs font-bold text-slate-900 dark:text-white mt-0.5">Toolbox Briefings</div>
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-[#050C17] border border-slate-200 dark:border-slate-800 flex items-center space-x-4 shadow-sm">
            ...
            <div>
              <div className="text-2xl font-black text-purple-600 dark:text-purple-400">QCS 2014</div>
              <div className="text-xs font-bold text-slate-900 dark:text-white mt-0.5">QA/QC Conformance</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="p-7 rounded-2xl bg-white dark:bg-[#0B1828] border border-slate-200 dark:border-slate-800 flex flex-col justify-between shadow-sm">
            <div>
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white mb-2">Permit to Work (PTW)</h3>
            ...
            <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-800 text-[11px] text-amber-700 dark:text-[#D4AF37] font-semibold">
          ...
          <div className="p-7 rounded-2xl bg-white dark:bg-[#0B1828] border border-slate-200 dark:border-slate-800 flex flex-col justify-between shadow-sm">
            <div>
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white mb-2">Independent Lab Testing</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <div className="p-7 rounded-2xl bg-white dark:bg-[#0B1828] border border-slate-200 dark:border-slate-800 flex flex-col justify-between shadow-sm">
            <div>
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white mb-2">Qatar Worker Welfare</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
