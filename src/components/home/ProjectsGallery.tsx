...
import { MapPin, Calendar, Building, ExternalLink, CheckCircle2 } from "lucide-react";
...
export const ProjectsGallery: React.FC = () => {
  ...
  return (
    <section id="projects" className="py-24 bg-[#0F172A] text-white relative">
            ...
            >
              ...
              <div className="h-56 relative overflow-hidden bg-slate-800">
                ...
                <div className="absolute top-3.5 right-3.5">
                  <span className="text-[10px] font-bold px-3 py-1 rounded-full bg-[#0B192C]/80 text-[#D4AF37] border border-[#D4AF37]/30 backdrop-blur-md">
                    {project.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                ...
                <div className="pt-4 border-t border-slate-800 flex items-center justify-between text-xs">
                  <span className="text-slate-500">Client: {project.client}</span>
